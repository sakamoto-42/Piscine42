...
/*   Updated: 2024/07/29 22:51:04 by juduchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <unistd.h>

void	ft_write_nbr(long int nbr, char *base)
{
	char	c;
...
void	ft_rec_putnbr_base(long int nbr, int base_len, char *base)
{
	if (nbr >= base_len)
...
void	ft_putnbr_base(int nbr, char *base)
{
	...
	ft_rec_putnbr_base(long_nbr, base_len, base);
}
